...
class Plotter:
    ...
    def plot_series(self, suffixes, out_name, x_axis, y_axis, title, subplotter, animate=False, plot_all=False):
    ...
    def plot_all_plots(self, filename, data, x_axis, y_axis, title, 
        ...
        for i in range(plots):
            ...
            axs[0, 0] = subplotter(axs[0, 0], data[i], legend[i], (lim_neg, lim_pos))
    ...
    def plot_subplots(self, filename, data, x_axis, y_axis, title, 
                   subplotter, log=False, legend=None, steps=None, 
                   zero=False):
        ...
        rows, cols, = vis_util.get_subplot_config(subplots) # subplot arrangement
    ...
    def plot_position(self):
       ...
       if self.params["dimensions"] == 2:
           self.plot_series(["ex", "ey"], "position.png", "Position (x)",
               "Position (y)", "Position plot", plat.vis_util.subplot_scatter_2d, plot_all=True)
